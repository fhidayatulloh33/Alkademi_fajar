...
public class OrderService : BaseDbService, IOrderService
{
    ...
    //     join alamat in DbContext.Alamats on a.IdAlamat equals alamat.IdOrder
    ...
    //             join d in DbContext.Products on c.IdProduct equals d.IdDetailOrder
    //             where c.IdOrder == a.IdDetaiOrder
    //             select new OrderDetailViewModel
    //             {
    //                 IdOrder = c.IdDetaiOrder,
    //                 Produk = d.Nama,
    //                 Harga = c.Harga,
    //                 Qty = c.JmlBarang,
    //                 SubTotal = c.SubTotal
